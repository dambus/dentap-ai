          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm text-slate-600 dark:text-slate-400">
            ...
            {patient.phone && (
              <div className="flex items-center gap-2">
                ...
                <a href={`tel:${patient.phone}`} className="text-teal-600 dark:text-teal-400 hover:underline">
                  {patient.phone}
                </a>
              </div>
            )}
            {patient.email && (
              <div className="flex items-center gap-2">
                ...
                <a href={`mailto:${patient.email}`} className="text-teal-600 dark:text-teal-400 hover:underline truncate">
                  {patient.email}
                </a>
              </div>
            )}
